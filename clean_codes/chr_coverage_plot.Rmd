...
#the coverage get from the calculation is not really how much percentage of each chromosome is covered, so it's unnecessary to be less than 1;
#It reflexts the distribution of normalized counts to each chromosome, considering the bias from chromosome size (bigger chromosomes in principle may get more reads by chance);
